// https://raw.githubusercontent.com/sstephenson/prototype/5fddd3ef8c93d8419fb45b7f8c6fddeb9f591150/src/prototype/lang/class.js
...
var Class = (function () {
  ...
  **/
  function Subclass() {}
  function create() {
    // var parent = null, properities = $A(arguments);
    ...
    for (var i = 0, length = properties.length; i < length; i++) {
      ...
      if (ancestor && Object.isFunction(value) &&
        ...
        value.valueOf = (function (method) {
          return function () { return method.valueOf() }
        })(method)

        value.toString = (function (method) {
          return function () { return method.toString() }
        })(method)
      }
